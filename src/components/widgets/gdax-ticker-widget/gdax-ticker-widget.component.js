...
class GdaxTickerWidget extends React.Component {
  ...
  async componentWillMount() {
    ...
    //BUG: this.strip.getBoundingClientRect() sometimes fails: "TypeError: Cannot read property 'getBoundingClientRect' of null"
    //Try fetching the relevant crypto information to the backend and serve to each user instead of fetching directly to the user.
    setTimeout(() => {
