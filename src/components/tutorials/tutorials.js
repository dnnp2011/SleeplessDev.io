...
import themeStyles from "./tutorials.style";
import scss from "./tutorials.module.scss";
        ...
        <Grid direction={panelDirection} container spacing={0}>
          <Paper className={classNames(scss.paper, classes["primary-paper"])}>
            <CardContent className={scss["landing-page-content"]}>
              ...
              <Typography variant='body1'>My name is Dalton, I'm the developer behind SleeplessDev.io! I worked hard to create an aesthetically pleasing and functionally smooth experience. You'll find other examples of my work, my resume, how to get in touch, and my blog. Some aspects of this site are still under development.</Typography>
            </CardContent>
          </Paper>
        </Grid>
      </Grid>
