...
// Portal components
import logoImage from '../../../assets/images/logo-lamp/profile-transparent-lamp.png';
  ...
  return (
    <MuiThemeProvider theme={sidenavTheme}>
      ...
      >
        ...
        >
          <Toolbar>
              <img src={logoImage} className={scss['portal-toolbar-brand']} alt="logo" onClick={handleOnClickLogo} />
          </Toolbar>
        </AppBar>
        {/* main menu */}
        {props.children}
